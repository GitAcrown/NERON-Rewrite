...
class MsgBoard(commands.Cog):
    ...
    async def on_raw_reaction_add(self, payload: discord.RawReactionActionEvent):
        ...
        notif = bool(self.data.get_keyvalue_table_value(guild, 'settings', 'NotifyHalfThreshold', cast=int))
        if notif:
    ...
    async def set_msgboard_channel(self, interaction: Interaction, channel: discord.TextChannel):
        ...
        if not bool(self.data.get_keyvalue_table_value(interaction.guild, 'settings', 'Enabled', cast=int)):
    ...
    async def get_msgboard_settings(self, interaction: Interaction):
        ...
        notif = bool(self.data.get_keyvalue_table_value(interaction.guild, 'settings', 'NotifyHalfThreshold', cast=int))
